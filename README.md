...
To understand the structure of this missingness more concretely, I ran permutation tests to determine whether the missingness of `avg_response_delay` depends on other observable columns.
